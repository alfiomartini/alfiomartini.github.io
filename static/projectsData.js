const jsProjects = [
  {
    ...
    language: "javascript",
    readme: `This app implements the Pig (dice) Game. Players take turns to roll a single dice as many times as they wish, adding all roll results to a running total (50 points), but losing their gained score for the turn if they roll a 1. It is implemented with HTML, CSS and JavaScript.`,
  ...
  },
  {
    ...
    language: "javascript",
    readme: `This is a simple app that allows the user to guess a secret number randomly generated by the program. The user interact with the application by trying to guess the secret number a limited amount of times. The program guides the user to the appropriate answer, by printing messages that state if the guess is bigger or smaller than the correct number. It is implemented with HTML, CSS and JavaScript.`,
  ...
  },
  {
    ...
    language: "javascript",
    readme: `This is a minimal bank application, that simulates usual transactions in a real world internet bank service, e.g. visualizing current account status and movements, money transfer, account closing, and loan requests. It is implemented with HTML, CSS and JavaScript.`,
